    ...
    return(
      <View >
        <Button 
          ...
          title="Slow"
        />
         <Text style={{margin:10,height:35,fontWeight:'bold',textAlign:'center',backgroundColor:'rgb(47, 54, 61)'}} ></Text>
        <Button 
          style = {{margin:50,backgroundColor:'black'}}
          title="Medium"
        />
...
AppRegistry.registerComponent('ChimeraBase', () => HomeScreen);